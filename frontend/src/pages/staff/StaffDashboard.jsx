    ...
    <div style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
          <h3 className="font-bold text-slate-700 mb-4 text-sm">আপনার টিমের বর্তমান অ্যাকাউন্ট নম্বর।</h3>
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-pink-100 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 40 40" className="w-7 h-7">
                  ...
                  <text x="50%" y="55%" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" dominantBaseline="middle">b</text>
                </svg>
              </div>
              <div>
                <div className="text-xs text-slate-400">বিকাশ</div>
                <div className="font-bold text-slate-800 text-sm">01706329691</div>
              </div>
            </div>
            {/* Nagad */}
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 40 40" className="w-7 h-7">
                  ...
                  <text x="50%" y="55%" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold" dominantBaseline="middle">নগদ</text>
                </svg>
              </div>
              <div>
                <div className="text-xs text-slate-400">নগদ</div>
                <div className="font-bold text-slate-800 text-sm">01706329691</div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
          <h3 className="font-bold text-slate-700 mb-4 text-sm">আপনার রেজিস্ট্রেশন সংখ্যা।</h3>
        ...
        {/* Card 3 — Office hours */}
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
          <h3 className="font-bold text-slate-700 mb-4 text-sm">আপনাদের অফিস এবং বিরতির সময়।</h3>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-xs text-slate-400 mb-0.5">অফিস</div>
                <div className="font-semibold text-slate-700 text-sm">সকল ১০টা থেকে রাত ১০টা</div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="bg-slate-100 rounded-lg p-2 flex-shrink-0">
              ...
              <div>
                <div className="text-xs text-slate-400 mb-0.5">বিরতি</div>
                <div className="font-semibold text-slate-700 text-sm">দুপুর ২টা থেকে বিকাল ৩টা ৩০ মিনিট</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100 mb-4">
        <h3 className="font-bold text-slate-700 mb-4 text-sm">গ্রাহক কত মাসের জন্য ঋণ নিতে চান?</h3>
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
        <h3 className="font-bold text-slate-700 mb-4 text-sm">গ্রাহক কত টাকা ঋণ নিতে চান?</h3>
        <div className="flex flex-wrap gap-2">
          {amounts.map(a => (
            <button
              key={a}
        ...
        {selDuration && selAmount && (
          <div className="mt-5 bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-800">
            <span className="font-bold">নির্বাচিত:</span> {selAmount} ঋণ, {selDuration} মেয়াদে
          </div>
        )}
      </div>
    </div>
